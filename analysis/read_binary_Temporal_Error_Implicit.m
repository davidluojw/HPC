...
figure;
M = 16000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_1', 'rb');
...
figure;
M2 = 18000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_2', 'rb');
...
figure;
M3 = 20000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_3', 'rb');
...
figure;
M4 = 22000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_4', 'rb');
...
figure;
M5 = 24000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_5', 'rb');
...
figure;
M6 = 26000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_6', 'rb');
...
figure;
M7 = 28000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_7', 'rb');
...
figure;
M8 = 30000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_8', 'rb');
...
figure;
M9 = 32000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_9', 'rb');
...
figure;
M10 = 34000;
fid = fopen('SOL_ERROR_IM_3_TEMPORAL_10', 'rb');
